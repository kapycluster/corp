...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MagicNode) DeepCopyInto(out *MagicNode) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MagicNode.
func (in *MagicNode) DeepCopy() *MagicNode {
	if in == nil {
		return nil
	}
	out := new(MagicNode)

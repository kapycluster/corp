...
func (x *KubeConfigData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KubeConfigData) ProtoMessage() {}

func (x *KubeConfigData) ProtoReflect() protoreflect.Message {
	mi := &file_kubeconfig_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KubeConfigData.ProtoReflect.Descriptor instead.
func (*KubeConfigData) Descriptor() ([]byte, []int) {
	return file_kubeconfig_proto_rawDescGZIP(), []int{1}
}

func (x *KubeConfigData) GetKubeConfig() string {
	if x != nil {
		return x.KubeConfig
	}
	return ""
...
var file_kubeconfig_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x13, 0x0a, 0x11, 0x4b, 0x75, 0x62,
	0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x30,
	0x0a, 0x0e, 0x4b, 0x75, 0x62, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x44, 0x61, 0x74, 0x61,
	...
	,
...
var file_kubeconfig_proto_goTypes = []interface{}{
	(*KubeConfigRequest)(nil), // 0: proto.KubeConfigRequest
	(*KubeConfigData)(nil),    // 1: proto.KubeConfigData
}
var file_kubeconfig_proto_depIdxs = []int32{
	0, // 0: proto.KubeConfig.GetKubeConfig:input_type -> proto.KubeConfigRequest
	1, // 1: proto.KubeConfig.GetKubeConfig:output_type -> proto.KubeConfigData

...
type TokenClient interface {
	GenerateToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenString, error)
}
...
func (c *tokenClient) GenerateToken(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*TokenString, error) {
	out := new(TokenString)
...
type TokenServer interface {
	GenerateToken(context.Context, *TokenRequest) (*TokenString, error)
...
func (UnimplementedTokenServer) GenerateToken(context.Context, *TokenRequest) (*TokenString, error) {
